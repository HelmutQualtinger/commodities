...
const CommodityGoldRatio = () => {
  ...
  const Gold = [279.11, 271.04, 309.73, 363.38, 409.72, 444.74, 603.46, 695.39, 871.96, 972.35, 1224.53, 1571.52, 1668.98, 1411.23, 1266.40, 1160.06, 1250.74, 1257.12, 1269.23, 1392.60, 1770.25, 1799.63, 1800.09, 1940.54, 2389.18, 3675.00];
  ...
  const commodities = {
    ...
    Öl: [30.38, 25.00, 26.19, 31.08, 41.47, 56.64, 66.05, 72.36, 99.67, 61.95, 79.48, 94.88, 94.05, 97.98, 93.17, 48.66, 43.29, 50.80, 64.94, 56.99, 39.16, 68.14, 94.58, 77.58, 76.55, 68.00],
    Brent: [28.50, 24.45, 25.02, 29.82, 38.24, 54.52, 65.14, 72.39, 97.33, 61.67, 79.61, 111.26, 111.63, 108.66, 98.95, 52.32, 43.74, 54.19, 71.31, 64.21, 41.96, 70.86, 99.04, 82.17, 79.69, 68.00],
    Erdgas: [2.42, 2.95, 2.75, 5.55, 6.18, 9.02, 6.91, 6.98, 8.86, 3.99, 4.38, 4.00, 2.76, 3.73, 4.37, 2.62, 2.52, 2.99, 3.15, 2.56, 2.03, 3.91, 6.45, 2.54, 2.21, 3.95],
    ...
    Weizen: [2.59, 2.78, 3.56, 3.56, 3.40, 3.42, 4.26, 6.48, 6.78, 4.87, 5.70, 7.24, 7.78, 6.87, 5.99, 5.13, 3.89, 4.43, 5.16, 5.17, 4.83, 6.78, 9.47, 7.49, 5.50, 4.62],
    Mais: [1.85, 2.00, 2.74, 2.51, 2.06, 2.00, 3.04, 3.76, 4.78, 3.56, 4.78, 6.22, 6.93, 5.39, 3.70, 3.61, 3.48, 3.49, 3.60, 3.83, 4.30, 5.70, 7.44, 5.50, 4.10, 3.60],
    Soja: [4.54, 4.90, 5.53, 5.58, 5.74, 5.66, 6.43, 10.13, 10.66, 9.59, 11.31, 12.50, 14.15, 13.02, 10.10, 8.97, 9.47, 9.34, 8.48, 8.74, 9.30, 12.37, 14.20, 12.55, 11.20, 10.35],
    Stahl: [427, 397, 410, 422, 574, 617, 634, 642, 780, 651, 675, 750, 720, 610, 650, 480, 450, 580, 700, 580, 540, 850, 900, 750, 700, 850],
    Kupfer: [1873.93, 1388.91, 1521.19, 1741.65, 2954.19, 3659.67, 6724.09, 8377.56, 6944.55, 5224.95, 7539.80, 8818.48, 8068.91, 7297.29, 6856.37, 5445.41, 4850.16, 6172.94, 6525.67, 5996.57, 6172.94, 9325.54, 8818.48, 8487.79, 9259.40, 10320.00],
    Alu: [1505, 1441, 1516, 1538, 1798, 2111, 2354, 2724, 2461, 1605, 2108, 2509, 2021, 1813, 1917, 1586, 1602, 1895, 2009, 1765, 1610, 2571, 2795, 2356, 2450, 2580],
    Silber: [4.95, 4.37, 4.60, 4.88, 6.67, 7.31, 11.55, 13.38, 14.99, 14.67, 20.19, 35.12, 31.15, 23.79, 19.08, 15.68, 17.14, 17.05, 15.71, 16.21, 20.55, 25.14, 21.73, 23.40, 28.50, 38.50],
    ...
    Hühnerfleisch: [1.85, 1.88, 1.92, 1.95, 2.05, 2.18, 2.28, 2.42, 2.58, 2.48, 2.62, 2.78, 2.95, 3.05, 3.12, 3.28, 3.15, 3.08, 3.22, 3.18, 3.45, 3.85, 4.15, 4.55, 4.75, 6.75],

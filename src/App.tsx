...
const CommodityGoldRatio = () => {
  ...
  // Data sources: World Bank Commodity Price Database (2000-2025), 2026 estimates from major banks and commodity market outlooks
  // 2026 data: Gold forecasts (JP Morgan $5,055, Goldman $4,900, consensus $4,400-$5,300), Oil/Brent ~$60, Silver $55-$75, Copper $10,700-$12,075, etc.

  const Gold = [279.11, 271.04, 309.73, 363.38, 409.72, 444.74, 603.46, 695.39, 871.96, 972.35, 1224.53, 1571.52, 1668.98, 1411.23, 1266.40, 1160.06, 1250.74, 1257.12, 1269.23, 1392.60, 1770.25, 1799.63, 1800.09, 1940.54, 2389.18, 3441.51, 4750];

  const commodities = {
    Gold: Gold,
    Dollar: [1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00],
    CHF: [0.59, 0.59, 0.64, 0.74, 0.81, 0.80, 0.80, 0.83, 0.93, 0.92, 0.96, 1.12, 1.06, 1.08, 1.09, 1.00, 0.99, 1.02, 1.02, 1.01, 1.06, 1.10, 1.04, 1.11, 1.15, 1.18, 1.20],
    EUR: [0.92, 0.89, 0.94, 0.88, 0.81, 0.81, 0.79, 0.73, 0.72, 0.72, 0.75, 0.72, 0.78, 0.75, 0.75, 0.90, 0.90, 0.88, 0.85, 0.89, 0.88, 0.85, 0.95, 0.93, 0.92, 0.92, 0.92],
    Lohn: [14.02, 14.36, 14.55, 14.83, 15.17, 15.57, 16.09, 16.68, 17.37, 17.78, 18.32, 18.96, 19.45, 19.96, 20.48, 20.99, 21.50, 22.05, 22.71, 23.32, 23.87, 24.92, 26.09, 27.35, 28.95, 33.50, 35.50],
    Strom: [0.08, 0.09, 0.09, 0.10, 0.11, 0.12, 0.13, 0.14, 0.16, 0.15, 0.17, 0.19, 0.20, 0.21, 0.22, 0.21, 0.20, 0.21, 0.22, 0.23, 0.24, 0.28, 0.35, 0.32, 0.30, 0.30, 0.33],
    Öl: [28.23, 24.35, 24.93, 28.90, 37.73, 54.43, 65.39, 72.70, 97.64, 61.86, 79.64, 110.94, 111.97, 108.86, 98.94, 52.37, 44.05, 54.39, 71.07, 64.03, 42.30, 70.44, 99.82, 82.62, 80.70, 69.04, 60.00],
    Brent: [28.27, 24.42, 24.97, 28.85, 38.30, 54.43, 65.39, 72.70, 97.64, 61.86, 79.64, 110.94, 111.97, 108.86, 98.94, 52.37, 44.05, 54.39, 71.07, 64.03, 42.30, 70.44, 99.82, 82.62, 80.70, 69.04, 60.00],
    Erdgas: [3.87, 3.96, 3.36, 5.55, 5.89, 9.02, 6.91, 6.98, 8.86, 3.99, 4.38, 4.00, 2.76, 3.73, 4.37, 2.62, 2.52, 2.99, 3.15, 2.56, 2.03, 3.91, 6.45, 2.54, 2.21, 3.95, 3.50],
    Pflanzenöl: [0.42, 0.38, 0.52, 0.56, 0.51, 0.52, 0.58, 0.93, 1.25, 0.75, 0.98, 1.19, 1.05, 0.87, 0.82, 0.68, 0.74, 0.82, 0.68, 0.70, 0.90, 1.45, 1.89, 1.15, 0.95, 0.88, 0.85],
    Weizen: [98.91, 107.72, 129.96, 138.58, 144.44, 135.72, 158.97, 238.59, 271.52, 185.95, 229.68, 285.91, 295.37, 276.73, 245.21, 206.38, 176.30, 178.18, 203.89, 211.28, 227.74, 281.66, 381.92, 257.74, 230.88, 219.62, 215.00],
    Mais: [186.50, 200.00, 274.00, 251.00, 206.00, 200.00, 304.00, 376.00, 478.00, 356.00, 478.00, 622.00, 693.00, 539.00, 370.00, 361.00, 348.00, 349.00, 360.00, 383.00, 430.00, 570.00, 744.00, 550.00, 410.00, 360.00, 350.00],
    Soja: [211.83, 195.83, 212.67, 264.00, 306.50, 274.69, 268.65, 383.10, 521.87, 423.62, 447.10, 537.52, 595.51, 551.39, 484.86, 392.12, 405.45, 393.38, 394.42, 368.95, 406.64, 583.32, 675.39, 597.90, 462.49, 414.34, 400.00],
    Stahl: [427, 397, 410, 422, 574, 617, 634, 642, 780, 651, 675, 750, 720, 610, 650, 480, 450, 580, 700, 580, 540, 850, 900, 750, 700, 850, 900],
    Kupfer: [1813.47, 1578.29, 1559.48, 1779.14, 2865.88, 3678.88, 6722.13, 7118.23, 6955.88, 5149.74, 7534.78, 8828.19, 7962.35, 7332.10, 6863.40, 5510.46, 4867.90, 6169.94, 6529.80, 6010.15, 6173.77, 9317.05, 8822.37, 8490.29, 9142.14, 9947.31, 11000.00],
    Alu: [1549.14, 1443.63, 1349.91, 1431.29, 1715.54, 1898.31, 2569.90, 2638.18, 2572.79, 1664.83, 2173.12, 2401.39, 2023.28, 1846.67, 1867.42, 1664.68, 1604.18, 1967.65, 2108.47, 1794.49, 1703.99, 2472.85, 2705.02, 2255.74, 2419.02, 2631.70, 2400.00],
    Silber: [4.95, 4.38, 4.60, 4.88, 6.66, 7.31, 11.56, 13.39, 15.00, 14.64, 20.15, 35.22, 31.14, 23.85, 19.07, 15.72, 17.15, 17.07, 15.71, 16.22, 20.54, 25.16, 21.79, 23.40, 28.27, 39.80, 65.00],
    Kakao: [0.91, 1.06, 1.77, 1.74, 1.55, 1.53, 1.59, 1.95, 2.58, 2.91, 3.10, 2.98, 2.40, 2.44, 3.06, 3.14, 2.89, 2.03, 2.29, 2.34, 2.57, 2.50, 2.69, 3.95, 5.50, 7.80, 5.50],
    Kaffee: [0.89, 0.56, 0.62, 0.64, 0.78, 1.10, 1.04, 1.18, 1.34, 1.34, 1.77, 2.64, 1.79, 1.24, 1.87, 1.43, 1.49, 1.28, 1.12, 1.02, 1.20, 1.69, 2.28, 1.77, 2.05, 2.65, 2.40],
    Hühnerfleisch: [1.31, 1.40, 1.39, 1.46, 1.67, 1.63, 1.53, 1.72, 1.87, 1.89, 1.89, 1.93, 2.08, 2.17, 2.32, 1.99, 1.85, 2.12, 2.24, 2.00, 1.63, 1.99, 1.68, 1.53, 1.46, 1.71, 1.80],
    Eier: [0.94, 0.91, 0.85, 0.99, 1.08, 1.25, 1.09, 1.15, 1.86, 1.12, 1.15, 1.41, 1.62, 1.57, 1.80, 2.47, 1.68, 1.47, 1.74, 1.40, 1.51, 1.67, 2.86, 2.80, 3.50, 4.92, 5.50],
    Butter: [1.85, 1.90, 1.85, 2.05, 2.20, 2.45, 2.55, 2.80, 3.60, 2.35, 2.50, 3.75, 3.45, 3.30, 3.50, 3.25, 3.40, 3.55, 3.20, 3.10, 3.45, 3.80, 4.20, 3.90, 4.50, 5.15, 5.50],
    Milch: [0.65, 0.67, 0.68, 0.70, 0.73, 0.78, 0.82, 0.88, 0.95, 0.85, 0.88, 0.98, 1.05, 1.08, 1.12, 1.08, 1.10, 1.15, 1.12, 1.10, 1.15, 1.25, 1.45, 1.38, 1.42, 1.62, 1.75],
    Brot: [0.95, 0.97, 0.99, 1.01, 1.04, 1.08, 1.12, 1.17, 1.25, 1.23, 1.27, 1.32, 1.37, 1.39, 1.40, 1.42, 1.44, 1.46, 1.50, 1.29, 1.51, 1.53, 1.74, 1.80, 1.86, 2.18, 2.35],
    Fleisch: [2.41, 2.28, 2.33, 2.30, 2.33, 2.55, 2.65, 2.94, 3.06, 2.77, 2.97, 3.28, 3.64, 3.78, 3.89, 4.23, 3.77, 3.72, 3.85, 3.80, 4.12, 4.59, 4.81, 5.21, 5.35, 7.60, 8.20],
